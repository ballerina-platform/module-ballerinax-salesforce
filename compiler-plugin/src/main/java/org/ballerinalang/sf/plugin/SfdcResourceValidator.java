...
public class SfdcResourceValidator {
    ...
    private static void updateDiagnostic(SyntaxNodeAnalysisContext ctx, Node node, String argName,
        ...
        DiagnosticInfo diagnosticInfo = getDiagnosticInfo(sfdcDiagnosticCodes, argName);
        ctx.reportDiagnostic(DiagnosticFactory.createDiagnostic(diagnosticInfo, node.location()));
    }

    private static DiagnosticInfo getDiagnosticInfo(SfdcDiagnosticCodes diagnostic, Object... args) {
