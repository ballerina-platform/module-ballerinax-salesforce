...
public remote function JsonUpsertOperator.upload(json payload) returns Batch | SalesforceError {
...
public remote function JsonUpsertOperator.getJobInfo() returns Job | SalesforceError {
...
#
# + return - Job record if successful else SalesforceError occured
public remote function JsonUpsertOperator.closeJob() returns Job | SalesforceError {
...
#
# + return - Job record if successful else SalesforceError occured
public remote function JsonUpsertOperator.abortJob() returns Job | SalesforceError {
...
# + batchId - batch ID 
# + return - Batch record if successful else SalesforceError occured
public remote function JsonUpsertOperator.getBatchInfo(string batchId) returns Batch | SalesforceError {
...
public remote function JsonUpsertOperator.getAllBatches() returns BatchInfo | SalesforceError {
...
public remote function JsonUpsertOperator.getBatchRequest(string batchId) returns json | SalesforceError {
...
public remote function JsonUpsertOperator.getBatchResults(string batchId) returns json | SalesforceError {
