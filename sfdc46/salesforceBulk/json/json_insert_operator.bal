...
public remote function JsonInsertOperator.upload(json payload) returns Batch | SalesforceError {
...
public remote function JsonInsertOperator.getJobInfo() returns Job | SalesforceError {
...
#
# + return - Job record if successful else SalesforceError occured
public remote function JsonInsertOperator.closeJob() returns Job | SalesforceError {
...
#
# + return - Job record if successful else SalesforceError occured
public remote function JsonInsertOperator.abortJob() returns Job | SalesforceError {
...
# + batchId - batch ID 
# + return - Batch record if successful else SalesforceError occured
public remote function JsonInsertOperator.getBatchInfo(string batchId) returns Batch | SalesforceError {
...
public remote function JsonInsertOperator.getAllBatches() returns BatchInfo | SalesforceError {
...
public remote function JsonInsertOperator.getBatchRequest(string batchId) returns json | SalesforceError {
...
public remote function JsonInsertOperator.getBatchResults(string batchId) returns json | SalesforceError {
