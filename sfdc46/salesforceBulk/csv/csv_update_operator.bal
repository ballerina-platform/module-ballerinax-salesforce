...
public remote function CsvUpdateOperator.upload(string csvContent) returns Batch | SalesforceError {
...
public remote function CsvUpdateOperator.getJobInfo() returns Job | SalesforceError {
...
#
# + return - Job record if successful else SalesforceError occured
public remote function CsvUpdateOperator.closeJob() returns Job | SalesforceError {
...
#
# + return - Job record if successful else SalesforceError occured
public remote function CsvUpdateOperator.abortJob() returns Job | SalesforceError {
...
# + batchId - batch ID 
# + return - Batch record if successful else SalesforceError occured
public remote function CsvUpdateOperator.getBatchInfo(string batchId) returns Batch | SalesforceError {
...
public remote function CsvUpdateOperator.getAllBatches() returns BatchInfo | SalesforceError {
...
public remote function CsvUpdateOperator.getBatchRequest(string batchId) returns string | SalesforceError {
...
public remote function CsvUpdateOperator.getBatchResults(string batchId) returns string | SalesforceError {
