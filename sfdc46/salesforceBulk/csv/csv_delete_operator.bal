...
public remote function CsvDeleteOperator.upload(string csvContent) returns Batch | SalesforceError {
...
public remote function CsvDeleteOperator.getJobInfo() returns Job | SalesforceError {
...
#
# + return - Job record if successful else SalesforceError occured
public remote function CsvDeleteOperator.closeJob() returns Job | SalesforceError {
...
#
# + return - Job record if successful else SalesforceError occured
public remote function CsvDeleteOperator.abortJob() returns Job | SalesforceError {
...
# + batchId - batch ID 
# + return - Batch record if successful else SalesforceError occured
public remote function CsvDeleteOperator.getBatchInfo(string batchId) returns Batch | SalesforceError {
...
public remote function CsvDeleteOperator.getAllBatches() returns BatchInfo | SalesforceError {
...
public remote function CsvDeleteOperator.getBatchRequest(string batchId) returns string | SalesforceError {
...
public remote function CsvDeleteOperator.getBatchResults(string batchId) returns string | SalesforceError {
