...
public function main() returns error? {
    ...
    string id1 = check getContactIdByName("Wanda", "Davidson", "Software Engineer Level 3");
    string id2 = check getContactIdByName("Natasha", "Romenoff", "Software Engineer Level 3");
    ...
    bulk:BulkJob|error updateJob = bulkClient->createJob("upsert", "Contact", "XML", "My_External_Id__c");
